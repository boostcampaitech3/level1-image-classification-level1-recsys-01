...
def train(data_dir, model_dir, args):
    ...
    #     base_lr=1e-5,
    #     max_lr=args.lr,
    #     step_size_down=len(dataset) * 2 // args.batch_size,
    #     step_size_up=len(dataset) // args.batch_size,
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            model.eval()
            val_loss_items = [] # clear lists to track next epoch
            val_acc_items = []
            figure = None
...
if __name__ == '__main__':
    ...
    parser.add_argument("--resize", nargs="+", type=list, default=[250, 190], help='resize size for image when training')
    ...
    parser.add_argument('--data_dir', type=str, default=os.environ.get('SM_CHANNEL_TRAIN', '/opt/ml/P_level1/images/images')) #/opt/ml/P_level1/images/images   /opt/ml/P_level1/CROP_images
